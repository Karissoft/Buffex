<template>
    ...
    <form @submit.prevent="update">
        ...
        <div class="mt-4">
            <button
                type="submit"
                class="mt-3 w-full inline-flex justify-center rounded-md border border-purple-300 shadow-sm px-5 py-2 bg-purple-600 text-base font-medium text-slate-200 hover:bg-purple-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:mt-0 sm:w-auto sm:text-sm"
...
export default {
    ...
    methods: {
        ...
        update() {
            this.$inertia.put(
                this.route("products.update", this.$props.product.id),
                this.form,
                {
                    onFinish: () => {
