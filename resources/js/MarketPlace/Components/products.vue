<template>
    <div class="bg-transparent">
        <div
            class="max-w-2xl mx-auto py-8 lg:py-12 px-4 sm:py-12 sm:px-6 lg:max-w-7xl lg:px-8 max-h-screen overflow-auto"
        >
            <div class="flex flex-col lg:flex-row justify-between mb-4">
                <h2
                    class="text-2xl font-extrabold tracking-tight text-gray-900 mb-4 lg:mb-0"
                >
                    Products
                </h2>
            ...
            >
                ...
                >
                    <div
                        class="min-h-72 bg-purple-500/30 aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:h-72 lg:aspect-none"
                    >
                    ...
                    <button
                        ...
                        type="button"
                        class="font-bold w-full px-4 py-2 text-sm whitespace-nowrap relative cursor-pointer border border-transparent rounded-md shadow-sm bg-purple-700 hover:bg-purple-500 flex justify-between"
                        :class="
                            inCart(product.id) ? 'bg-slate-400 opacity-70' : ''
                        "
                    >
...
export default {
    ...
    methods: {
        ...
        addtocart(product) {
            ...
            let newprod = { ...product, color: this.color, color: this.size };
