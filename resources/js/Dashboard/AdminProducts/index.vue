...
<template>
  <div class="w-full overflow-hidden">
    <div class="grid grid-cols-3 gap-6 mb-4">
      ...
      <div>
        <select  @change="searchproducts" v-model="query" class="border-gray-200 border rounded-md text-sm">
                ...
                <tr v-for="products in filteredproducts" :key="products.id">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                      <img class="w-8 h-8 rounded-md" :src="products.images.length?products.images[0]:''" />
                      <div class="ml-4">
                  ...
                  <td class="px-6 py-4">
                    <div class="text-sm text-gray-900 w-[180px]">
      ...
      if (this.filterData) {
        if (
          ...
          return products.filter(
            (item) =>
              this.filterData.productsIds.includes(item.user_id) ||
