                            ...
                            >
                                                        ...
                                                        <div>
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                    <p
                                                                        class="text-sm font-medium text-gray-900 mb-0"
                                                                    >
                                                                        {{
                                                                            currency(
                                                                                product.price *
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <span
                                                                    ...
                                                                    "
                                                                    ><MinusCircleIcon
                                                                        class="cursor-pointe w-5 h-5 text-purple-500"
                                                                /></span>
                                                                <span
                                                                ...
                                                                <span
                                                                    ...
                                                                    "
                                                                    ><PlusCircleIcon
                                                                        class="w-5 h-5 text-purple-500 cursor-pointer" /></span
                                                            ></span>
                                ...
                                >
                                    ...
                                    <div class="mt-6">
                                        <a
                                            href="/checkout"
                                            class="flex justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-purple-600 hover:bg-purple-700"
                                            >Checkout</a
                                        >
                                    </div>
                                    <div
